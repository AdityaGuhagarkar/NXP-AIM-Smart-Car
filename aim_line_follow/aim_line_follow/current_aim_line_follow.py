...
class LineFollow(Node):
    ...
    def listener_callback(self, msg):
        ...
        if((self.delayer > 23 and self.delayer < 25) ):
            self.speed_vector.x = 0.15
            steer = -0.30
            steer = steer
        ...
        if((int)((self.flag_data).data) == 100 or (self.i>625 and self.i<650)):
            self.speed_vector.x = 0.55
            self.brown_mode = 1
